...
export const useCartStore = defineStore(
    'cartStore', () => {
        ...
        const countBooks =  basket.books.reduce((total, book) => total + book.quantity, 0);

        const countBooksInCart = computed(() => {
            return basket.books.reduce((total, book) => total + book.quantity, 0);
        });
